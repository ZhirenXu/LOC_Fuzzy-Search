...
## ask user if he/she wants to conduct fuzzy search. If not, fill all unfound keywords
## in null
# @return   choice
def askForFuzzy():
    print("\nDo you want to conduct Fuzzy Search? (Y/N): ")
    #invalid input protection
    choice = input()
    while (choice != 'Y' or choice != 'y' or choice != "N" or choice != 'n'):
        print("\nInvalid Option. Please type again. Or press ctrl+c to exit.")
        print("\nDo you want to conduct Fuzzy Search? (Y/N): ")
        choice = input()
    return choice
